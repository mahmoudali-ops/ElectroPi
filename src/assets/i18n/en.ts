...
DESC: "Discover delicious flavors with our handpicked food experiences, local cuisine, gourmet meals, street food tours, seafood delights, and authentic dining adventures across Egypt." ,
  ...
  STORE: {
    BRAND: 'Electro Store',
    TAGLINE: 'Electronics, smart prices, fast checkout.',
    HERO_TITLE: 'Shop the latest tech',
    HERO_SUB: 'Browse categories, add to cart, and pay online or on delivery.',
    ALL_CATEGORIES: 'All',
    ...
    LOADING: 'Loading…',
    EMPTY_PRODUCTS: 'No products in this category yet.',
    CART: 'Cart',
    ...
    ORDER_SUCCESS: 'Payment completed. Thank you!',
    ORDER_FAILED: 'Payment was cancelled or failed.',
    ...
    STRIPE_REDIRECT: 'Redirecting to secure payment…'
  }
